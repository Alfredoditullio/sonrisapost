...
Posts cannot be deleted through the DentalCore Social tools - if the user wants to delete a post, tell them to do it themselves in the DentalCore Social app; never offer to delete a post.
`,
