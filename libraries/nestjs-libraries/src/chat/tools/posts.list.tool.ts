...
Posts cannot be deleted through the SonrisaPost tools - if the user wants to delete a post, tell them to do it themselves in the SonrisaPost app; never offer to delete a post.
`,
