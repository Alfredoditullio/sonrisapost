  ...
  return [
      ...
      ? [
          {
            title: t(
              ...
              'Am I going to be charged by DentalCore Social?'
            ),
            description: t(
              'faq_to_confirm_credit_card_information_postiz_will_hold',
              'To confirm credit card information DentalCore Social will hold $2 and release it immediately, you can cancel your subscription anytime from settings without talking to a person'
            ),
          },
        ]
      : []),
    {
      title: t(
        ...
        `Can I trust ${isGeneral ? 'DentalCore Social' : 'DentalCore Social'}?`
      ),
      description: t(
        ...
        `${
          ...
          isGeneral ? 'DentalCore Social' : 'DentalCore Social'
        } will live forever. You can check out the entire code or use it for personal projects. To view the open-source repository, <a href="https://github.com/dentalcoresocial/dentalcore-app" target="_blank" style="text-decoration: underline;">click here</a>.`
      ),
    },
    {
