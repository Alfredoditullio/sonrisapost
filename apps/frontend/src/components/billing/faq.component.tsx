  ...
  return [
      ...
      ? [
          {
            title: t(
              ...
              'Am I going to be charged by SonrisaPost?'
            ),
            description: t(
              'faq_to_confirm_credit_card_information_postiz_will_hold',
              'To confirm credit card information SonrisaPost will hold $2 and release it immediately, you can cancel your subscription anytime from settings without talking to a person'
            ),
          },
        ]
      : []),
    {
      title: t(
        ...
        `Can I trust ${isGeneral ? 'SonrisaPost' : 'SonrisaPost'}?`
      ),
      description: t(
        ...
        `${
          ...
          isGeneral ? 'SonrisaPost' : 'SonrisaPost'
        } will live forever. You can check out the entire code or use it for personal projects. To view the open-source repository, <a href="https://github.com/Alfredoditullio/sonrisapost" target="_blank" style="text-decoration: underline;">tocá acá</a>.`
      ),
    },
    {
