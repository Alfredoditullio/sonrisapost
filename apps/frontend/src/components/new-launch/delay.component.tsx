            ...
            {delayOptions.map((option) => (
              <div
                ...
                className={clsx(
                  ...
                  currentDelay === option.value && 'bg-[#0F766E] text-white hover:bg-[#0F766E]'
                )}
              >
                {option.label}
              </div>
          ...
          <div className="border-t border-newTextColor/10 mt-[8px] pt-[8px]">
            <div className="flex gap-[4px]">
              ...
              <button
                ...
                className="h-[32px] px-[10px] rounded-[4px] bg-[#0F766E] text-white text-[12px] font-[600] hover:bg-[#0F766E]/80"
              >
                Set
              </button>
            </div>
